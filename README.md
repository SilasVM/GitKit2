...
There are currently two KitClients that can be used with GitKit. Both of these KitClients run remotely within _GitPod Workspaces_ and students interact with them through a Web browser. An instructor can choose which to use based on the needs of their course and students.
- __Linux KitClient:__ This KitClient provides students a complete Linux virtual desktop environment.
- __VSCode KitClient:__ This KitClient provides an editor and a Linux terminal via the Visual Studio Code interface.

To run a KitClient, students themselves need will need a free [_GitPod_ account](https://gitpod.io/login). Precise instructions for how to create this account are provided in the [first GitKit activity](#topic-1-community-and-collaboration).
...
- **Question 12b (Linux KitClient) / Question 8 (VSCode KitClient)**
...
- **Question 13 (Linux KitClient) / Question 11 (VSCode KitClient)**
